...
not_authoritative_for:
  - detailed why (→ decisions/ ADR files)
---
```

## Platform Decisions (cross-ref)
...
- هر ADR accepted → یک row اینجا
- Superseded → status update + link to new ADR
- Non-ADR product decisions → row with link to spec/knowledge
